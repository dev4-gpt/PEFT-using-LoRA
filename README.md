...
**[Link to Full Project Report (PDF)](DL_project_2.pdf)** | **[Link to Jupyter Notebook (ipynb)](Roberta_PEFT.ipynb)**
...
![Training Loss and Accuracy Plots](training_metrics.png)
...
| Percentage Trainable    | 0.7225%       |
| Final Evaluation Accuracy | **90.04%** |
